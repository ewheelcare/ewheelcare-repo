...
if($pay_type!="CREDIT"){
$sql = "update service_trans set pay_type='".$pay_type."',ref_no='".$ref_no."',pending=pending-".$paid_amount." WHERE trans_id='".$trans_id."'";
...
$sql = "INSERT INTO payments (
    ...
    '$payment_id', STR_TO_DATE('$payment_date', '%d-%m-%Y'), 'CREDIT', 
...
$insert_pay_track = "insert into pay_track(payment_id,amount_settled,trans_id,mode) values('".$payment_id."','".$paid_amount."','".$trans_id."','service')";
