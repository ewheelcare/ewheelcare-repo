...
; (function ($, window, document) {
    ...
    $.extend(SearchableOptionList.prototype, {
        ...
        addUiElements: function () {
            ...
            if (this.settings.showSelectAll && this.useCheckboxes) {
                ...
                this.selectAllButton = $('<a href="#" class="sol-select-all" />')
                    ...
                    this.doneButton = $('<a href="#" id="sol-done" STYLE="MARGIN-LEFT:20%"/>')
                    .on('click', function (e) { e.preventDefault(); iocl.hide_me(); return false; })
                    .html(this.settings.texts.done)
        ...
        hide_me: function () {
           // $( ".sol-selection-container" ).css('visibility','hidden');
           //resetFunction.call(sol);
          //  sol.container.trigger('sol-closed');
          $( 'body' ).click ();
