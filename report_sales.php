...
<?php }?>
	...
	<tr>
		...
		<?php $sql="SELECT s.trans_id,d.subtrans_id,s.trans_date,c.company_name,i.item_name,d.total,d.tax_amount,d.tax_amount_sgst,s.gst FROM sales_trans s, sales_trans_det d,customer c,item i WHERE s.trans_id=d.trans_id and s.active_status='A' AND D.active_status='A' AND s.customer=c.customer_id and d.item_id=i.item_id ";
...
$total=$row["total"];
$tax_amount=$row["tax_amount"]+$row["tax_amount_sgst"];
$gst=$row["gst"];?>
<tr>
