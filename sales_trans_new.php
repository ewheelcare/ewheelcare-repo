...
t.subtrans_id";
                                    ...
                                    while ($row_det = $result_det->fetch_assoc()) {
                                        ...
                                        if (strpos($CUSTOMER_GST, "37") === 0 || trim($CUSTOMER_GST) === "") {
                                            $tax_pc = $row_det["tax"];
                                ...
                                <div class="col-md-5">
                                    <table class="table table-bordered table-sm" style="background-color: #f8f9fa;">
                                        <tbody>
                                            <tr>
                                                <td
                                                    style="font-weight: 600; font-size: 0.9em; vertical-align: middle; color: #444;">
                                                    TAXABLE VALUE</td>
                                                <td class="text-right"
                                                    style="width: 150px; background-color: #fff; vertical-align: middle;">
                                                    <input id="price_amount" class="form-control text-right" readonly
                                                        value="<?php echo number_format((float) $price_amount, 2, '.', ''); ?>"
                                                        style="border:none; background:transparent; text-align:right; font-weight: bold; padding: 0; margin: 0; color: #333; height: auto;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                ...
                                                <td class="text-right"
                                                    ...
                                                    <input id="cgst_amount" class="form-control text-right" readonly
                                                        value="<?php echo number_format((float) $cgst_amount, 2, '.', ''); ?>"
                                                        style="border:none; background:transparent; text-align:right; font-weight: bold; padding: 0; margin: 0; color: #333; height: auto;">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right"
                                                    style="background-color: #fff; vertical-align: middle;">
                                                    <input id="sgst_amount" class="form-control text-right" readonly
                                                        value="<?php echo number_format((float) $sgst_amount, 2, '.', ''); ?>"
                                                        style="border:none; background:transparent; text-align:right; font-weight: bold; padding: 0; margin: 0; color: #333; height: auto;">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right"
                                                    style="background-color: #fff; vertical-align: middle;">
                                                    <input id="igst_amount" class="form-control text-right" readonly
                                                        value="<?php echo number_format((float) $igst_amount, 2, '.', ''); ?>"
                                                        style="border:none; background:transparent; text-align:right; font-weight: bold; padding: 0; margin: 0; color: #333; height: auto;">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right"
                                                    ...
                                                    <input id="trans_amount" class="form-control text-right" readonly
                                                        value="<?php echo number_format((float) $grand_total, 2, '.', ''); ?>"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    DISCOUNT</td>
                                                <td class="text-right"
                                                    style="background-color: #fff; vertical-align: middle; padding: 2px;">
                                                    <input id="discount_amount" <?php echo $final_disabler; ?>
                                                        class="form-control form-control-sm text-right"
                                                        value="<?php echo $discount_amount; ?>"
                                                        onblur="calculate_final()"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"
                                                    style="background-color: #fff; vertical-align: middle; padding: 2px;">
                                                    <input id="roundoff_amount" <?php echo $final_disabler; ?>
                                                        class="form-control form-control-sm text-right"
                            ...
                            <?php if ($active_status == "A") { ?>
                                ...
                                <center>
                                    <button class="btn btn-success"
                                        disabled><?php echo !empty($pay_type) ? "Paid" : "Saved already"; ?></button>
                                    &nbsp;
                                    <button class="btn btn-danger" id="invoice" onclick="get_invoice()">Print</button>
                                    <button class="btn btn-primary" id="invoice_pdf" onclick="get_invoice_pdf()">Get
                                        Invoice</button>
                                    &nbsp;
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td><select class="form-control" id="edit_service" onchange="populate_edit_det()">
                                    <option value="">--select---</option>
                                    <?php $sql = "SELECT item_id as service_id, item_name as service_name, item_description as service_description, cost, ifnull(tax_pc,9) tax_pc, ifnull(tax_pc_sgst,9) tax_pc_sgst FROM item WHERE status='A' ORDER BY 1";
                                    $result = $conn->query($sql);
                                    while ($row1 = $result->fetch_assoc()) { ?>
                                        <option
    ...
    <script>
        ...
        function get_invoice_pdf() {
            let trans_id = $("#trans_id").val();
            let url = "sales_receipt_new.php?trans_id=" + trans_id + "&action=DOWNLOAD";
            window.open(url, '_blank');
        }
