...
function loadInvoices(mobile,obj)
{
    let tr = $(obj).closest("tr");
    let detailRow = tr.next(".invoice-row");
    ...
    $.post(
        ...
        function(data)
        {
            detailRow.find(".invoice-container").html(data);
...
function loadInvoiceDetails(trans_id,obj)
{
    let tr = $(obj).closest("tr");
    ...
    $.post(
        ...
        function(data)
        {
            detailRow.find(".detail-container").html(data);
            detailRow.data("loaded", true);
            detailRow.show();
        }
    );
