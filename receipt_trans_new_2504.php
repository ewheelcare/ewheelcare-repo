...
<td><?php echo $det_hsn;?></td>
	...
	<td><input class="form-control"  <?php echo $final_disabler;?>  id="price_<?php echo $slno;?>"  onblur="calculate('<?php echo $slno;?>')"></td>
...
<td><span id="hsn_<?php echo $slno;?>"></span></td>
	...
	<td><input class="form-control tooltip-input" id="qty_<?php echo $slno;?>"
...
<td><input type="hidden"    id="discount_<?php echo $slno;?>" value="" onblur="calculate('<?php echo $slno;?>')"></td>
...
<td><input class="form-control" <?php echo $final_disabler;?>   id="roundoff_<?php echo $slno;?>" value="" onblur="calculate('<?php echo $slno;?>')"></td>
	<td><input class=" discount" <?php echo $final_disabler;?>   id="remarks_<?php echo $slno;?>" value="" onblur="calculate('<?php echo $slno;?>')"></td>
		<td><input class="form-control" <?php echo $final_disabler;?> readonly  id="show_total_<?php echo $slno;?>" value="" onblur="calculate('<?php echo $slno;?>')"></td>
<td>
...
<TD><input id="discount_amount" class="form-control discount" readonly value="<?php echo $discount_amount;?>"></TD>
	<TD><input id="trans_amount" class="form-control" readonly value="<?php echo $grand_total;?>"></TD>

	<TD><input id="roundoff_amount" class="form-control" readonly value="<?php echo $roundoff_amount;?>"></TD>
...
function update_summary(){
    ...
    let subtotal = parseFloat($("#price_amount").val()) || 0;
...
var slno=rows.length;
	...
	document.getElementById(hsn_selector).value=hsn;
...
let show_total_selector = "show_total_"+service;
