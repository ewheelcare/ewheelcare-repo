...
<div class="col-md-12">
<select class="form-control" name="item_search" id="item_search" list="item_list" <?php echo $final_disabler;?> multiple="multiple" style="max-width:300px!important">
...
<tbody>
<?php
$sql_det="SELECT t.subtrans_id,t.item_id,t.cost,price,ifnull(t.discount,'0') discount,t.qty,t.total, t.tax,t.tax_amount,t.tax_sgst,t.total,t.remarks,t.tax_amount_sgst,t.tax_igst,t.tax_amount_igst,i.item_name FROM receipt_trans_det t,item i where i.item_id=t.item_id and t.trans_id='".$trans_id."' and t.trans_id!='' and t.active_status='A' order by t.subtrans_id";	
...
<span class="alert alert-info" style="text-align:right:font-weight:bold;width:100%">Total Invoice Amount <input id="trans_amount" class="form-control" readonly value="<?php echo $grand_total;?>" style="width:160px;float:right">
...
function load_service(service,price, gst,sgst,name){
...
var slno=rows.length;
	...
	if (str.startsWith("37")) {
		document.getElementById(sgst_selector).value=parseInt(sgst);
		document.getElementById(gst_selector).value=parseInt(gst);
	}else{
		document.getElementById(igst_selector).value=parseInt(gst)+parseInt(sgst);
