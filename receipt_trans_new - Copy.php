...
$result = $conn->query($sql);
while ($row1 = $result->fetch_assoc()) {?>
<option value="<?php echo $row1["item_name"]?>~<?php echo $row1["item_description"]?>~<?php echo $row1["cost"]?>~<?php echo $row1["purchase_tax_cgst"]?>~<?php echo $row1["purchase_tax_igst"]?>~<?php echo $row1["item_id"]?>~<?php echo $row1["hsn"]?>"><?php echo $row1["item_name"]?></option>
<?php }?>
</select>
...
<td><input class="form-control" <?php echo $final_disabler;?>   id="roundoff_<?php echo $slno;?>" value="<?php echo $det_roundoff;?>" onblur="calculate('<?php echo $slno;?>')"></td>
	...
	<td><input class="form-control" <?php echo $final_disabler;?>   id="show_total_<?php echo $slno;?>" value="<?php echo  $det_price+$det_discount+$det_roundoff;?>" onblur="calculate('<?php echo $slno;?>')"></td>
<td>
<button class="btn btn-xs btn-danger" <?php echo $final_disabler;?> onclick="del_service_det('<?php echo $slno;?>','<?php echo $det_subtrans_id;?>')"  id="del_<?php echo $slno;?>">X</button>
</td>
</tr>
...
<input class="form-control tooltip-input qty-box" id="qty_<?php echo $slno;?>" onblur="calculate('<?php echo $slno;?>')">
</div>
</td>

<td><input class="form-control amount-box" id="price_<?php echo $slno;?>" onblur="calculate('<?php echo $slno;?>')"></td>

<td><input class="form-control amount-box" readonly id="cost_<?php echo $slno;?>"></td>

<td style="display:none"><input class="form-control amount-box" readonly id="gst_<?php echo $slno;?>"></td>

<td style="display:none"><input class="form-control amount-box" readonly id="sgst_<?php echo $slno;?>"></td>

<td style="display:none"><input class="form-control amount-box" readonly id="igst_<?php echo $slno;?>"></td>

<td style="display:<?php echo $visibility;?>"><input class="form-control amount-box" readonly id="tax_gst_<?php echo $slno;?>"></td>

<td style="display:<?php echo $visibility;?>"><input class="form-control amount-box" readonly id="tax_sgst_<?php echo $slno;?>"></td>

<td style="display:<?php echo $visibility;?>"><input class="form-control amount-box" readonly id="tax_igst_<?php echo $slno;?>"></td>

<td><input class="form-control amount-box" id="discount_<?php echo $slno;?>" onblur="calculate('<?php echo $slno;?>')"></td>
...
<td><input class="form-control amount-box" id="roundoff_<?php echo $slno;?>" onblur="calculate('<?php echo $slno;?>')"></td>

<td><input class="form-control amount-box" readonly id="show_total_<?php echo $slno;?>"></td>

<td>
<button class="btn btn-xs btn-danger" onclick="del_service_det('<?php echo $slno;?>','')" id="del_<?php echo $slno;?>">X</button>
</td>
...
<span class="alert alert-info" style="text-align:right:font-weight:bold;width:100%;display:block">Total Discount <input id="discount_amount" class="form-control" readonly value="<?php echo $discount_amount;?>" style="width:160px;float:right"></span>
...
<span class="alert alert-info" style="text-align:right:font-weight:bold;width:100%;display:block">Total Invoice Amount(Rounede Off) <input id="trans_amount" class="form-control" readonly value="<?php echo ($grand_total - floor($grand_total)) > 0.5 ? ceil($grand_total) : $grand_total;?>" style="width:160px;float:right"></span>-->
		<!-- The above lines commented -->
...
<!-- <TD>discount<input id="discount_amount" class="form-control discount" readonly value="<?php echo $discount_amount;?>"></TD> -->
...
<!--	<TD>PRC<input id="roundoff_amount" class="form-control" readonly value="<?php echo $roundoff_amount;?>"></TD> -->
...
<div class="row mt-3">
  ...
  <div class="col-md-4">
    ...
    <!--    <td>Subtotal</td>
      ...
      <tr>
        <td>Taxable Value</td>
        <td class="text-right" id="sum_taxable"><?php echo number_format($price_amount,2); ?></td>
      </tr>

      <tr>
        <td>CGST</td>
        <td class="text-right" id="sum_cgst"><?php echo number_format($cgst_amount,2); ?></td>
      </tr>

      <tr>
        <td>SGST</td>
        <td class="text-right" id="sum_sgst"><?php echo number_format($sgst_amount,2); ?></td>
      </tr>
...
subtrans_id:subtrans_id,
  ...
  function(data, status){
	...
	$("#price_amount").val(parseFloat($.trim(data).split("~")[8]));
	$("#discount_amount").val(parseFloat($.trim(data).split("~")[6]));
	$("#roundoff_amount").val(parseFloat($.trim(data).split("~")[7]));
		update_summary(); 
		console.log(amount_paid);	
...
function del_service_det(service,subtrans_id){
...
function setwheels(){
  ...
  function(data, status){
    ...
    load_service(parts[5],parts[2],parts[3],parts[4],parts[0],parts[6]);
}
