                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="item_name"
                                        value="<?= htmlspecialchars($item['item_name']) ?>" placeholder="Item name">
                            ...
                            <div id="subItemsBlock" style="<?= $hasSubItems ? '' : 'display:none;' ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control si-hsn"
                                                        value="<?= htmlspecialchars($si['hsn']) ?>" placeholder="HSN code">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label>Cost <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control si-cost"
                                                        value="<?= htmlspecialchars($si['cost']) ?>" placeholder="0.00">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label>Percentage (%) <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control si-perc"
                                                        value="<?= htmlspecialchars($si['perc']) ?>" placeholder="0">
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                ...
                                <div id="percentageSummary" class="p-3 border rounded bg-light mb-2">
                                    <div class="d-flex flex-wrap align-items-center" style="gap:16px;">
                                        <span>Sub Item Total: <span class="badge badge-info"
                                                id="subTotal">0</span>%</span>
                                        <span>Parent Remaining: <span class="badge badge-success"
                                                id="parentRemaining">100</span>%</span>
                                    </div>
