        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid py-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="vendor">
                                        ...
                                        while ($row = $result->fetch_assoc()) { ?>
                                            <option value="<?php echo $row['vendor_id']; ?>" <?php echo (isset($_POST['vendor']) && $_POST['vendor'] == $row['vendor_id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($row['company_name']); ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
                    ...
                    <!-- Report Table -->
                    <?php
                    $from_date = isset($_POST["from_date"]) ? $conn->real_escape_string($_POST["from_date"]) : '';
                    $to_date = isset($_POST["to_date"]) ? $conn->real_escape_string($_POST["to_date"]) : '';
                    $item = isset($_POST["item"]) ? $conn->real_escape_string($_POST["item"]) : '';
                    $vendor = isset($_POST["vendor"]) ? $conn->real_escape_string($_POST["vendor"]) : '';
                    $shop_id = isset($_COOKIE["shop"]) ? $conn->real_escape_string($_COOKIE["shop"]) : '';
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($rows as $row):
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="trans-id"><?php echo htmlspecialchars($row['trans_id']); ?></span>
                                                ...
                                                <td><span
                                                        class="vendor-name"><?php echo htmlspecialchars($row['company_name']); ?></span>
                                                </td>
                                                <td><span
                                                        class="item-name"><?php echo htmlspecialchars($row['item_name']); ?></span>
                                                </td>
                                    ...
                                    <tfoot>
                                        <tr class="tfoot-row">
                                            ...
                                            <td style="text-align:right">
                                                ₹<?php echo number_format($grand_total - $grand_tax, 2); ?></td>
                                            <td style="text-align:right">₹<?php echo number_format($grand_tax, 2); ?>
                                            </td>
